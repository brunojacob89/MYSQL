...
SELECT DATEDIFF(CURRENT_TIMESTAMP(), '1989-12-08') AS RESULTADO;
...
SELECT DISTINCT DATA_VENDA, DAYNAME(DATA_VENDA) AS DIA, MONTHNAME(DATA_VENDA) AS MES, YEAR(DATA_VENDA) FROM notas_fiscais;